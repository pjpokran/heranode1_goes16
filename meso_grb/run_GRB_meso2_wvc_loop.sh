...
while :; do
  ...
  for file in /home/ldm/data/grb-east-mesotemp/09/*RadM2*
  do
#  if [ ! -z "$file" ]
  if [ $file == "/home/ldm/data/grb-east-mesotemp/09/*RadM2*" ]
  then
    echo NO FILES
  else
      echo process $file
      /home/poker/miniconda3/envs/goes16_201710/bin/python goes16_GRB_meso2_wvc.py $file
      /bin/rm $file
  fi
  done
