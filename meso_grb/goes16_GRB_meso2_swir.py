...
filename9s="/dev/shm/goes16_images/grb/meso_swir/"+ctime_file_string+".jpg"
...
filename90="/whirlwind/goes16/grb/meso_swir/latest_meso_2s.jpg"

if not os.path.exists('/dev/shm/goes16_images/grb/meso_swir'):
    os.makedirs('/dev/shm/goes16_images/grb/meso_swir')
...
shutil.copy(filename9, "/whirlwind/goes16/grb/meso_swir/latest_meso_2.jpg")
shutil.copy(filename9, filename9t)
open(filename9s, 'a').close()


import glob
file_list = glob.glob('/dev/shm/goes16_images/grb/meso_swir/*' + list_string)
file_list.sort()
#print("file list is ",file_list)

thefile = open('/whirlwind/goes16/grb/meso_swir/meso_2_30_temp.list', 'w')
...
for item in thelist:
    ...
    thefile.write(tail + '\n')
thefile.close
os.rename('/whirlwind/goes16/grb/meso_swir/meso_2_30_temp.list','/whirlwind/goes16/grb/meso_swir/meso_2_30.list')

thefile = open('/whirlwind/goes16/grb/meso_swir/meso_2_60_temp.list', 'w')
...
for item in thelist:
    ...
    thefile.write(tail + '\n')
thefile.close
os.rename('/whirlwind/goes16/grb/meso_swir/meso_2_60_temp.list','/whirlwind/goes16/grb/meso_swir/meso_2_60.list')
