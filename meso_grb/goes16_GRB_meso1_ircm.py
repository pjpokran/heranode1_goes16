...
filename9s="/dev/shm/goes16_images/grb/meso_ircm/"+ctime_file_string+".jpg"
filename90="/whirlwind/goes16/grb/meso_ircm/latest_meso_1s.jpg"
...
if not os.path.exists('/dev/shm/goes16_images/grb/meso_ircm'):
    os.makedirs('/dev/shm/goes16_images/grb/meso_ircm')
...
shutil.copy(filename9, "/whirlwind/goes16/grb/meso_ircm/latest_meso_1.jpg")
shutil.copy(filename9, filename9t)
open(filename9s, 'a').close()


import glob
file_list = glob.glob('/dev/shm/goes16_images/grb/meso_ircm/*' + list_string)
file_list.sort()
#print("file list is ",file_list)

thefile = open('/whirlwind/goes16/grb/meso_ircm/meso_1_30_temp.list', 'w')
...
for item in thelist:
    ...
    thefile.write(tail + '\n')
thefile.close
os.rename('/whirlwind/goes16/grb/meso_ircm/meso_1_30_temp.list','/whirlwind/goes16/grb/meso_ircm/meso_1_30.list')

thefile = open('/whirlwind/goes16/grb/meso_ircm/meso_1_60_temp.list', 'w')
...
for item in thelist:
    ...
    thefile.write(tail + '\n')
thefile.close
os.rename('/whirlwind/goes16/grb/meso_ircm/meso_1_60_temp.list','/whirlwind/goes16/grb/meso_ircm/meso_1_60.list')
